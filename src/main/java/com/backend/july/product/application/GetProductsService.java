...
public class GetProductsService {
    ...
    private ProductCursor createNextCursor(List<Product> products, ProductSortType sortType, boolean hasNext) {
        ...
        return switch (sortType) {
            ...
            case PRICE_LOW, PRICE_HIGH -> ProductCursor.price(lastProduct.getId(), lastProduct.getPrice());
        };
    }
}
