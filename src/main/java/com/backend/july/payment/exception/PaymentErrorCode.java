...
public enum PaymentErrorCode implements ErrorCode {
    ...
    PAYMENT_PREPARATION_NOT_FOUND(HttpStatus.NOT_FOUND, "결제 준비 정보를 찾을 수 없습니다."),
    ...
    TOSS_PAYMENT_AMOUNT_MISMATCH(HttpStatus.CONFLICT, "결제 승인 금액과 주문 금액이 일치하지 않습니다."),
    TOSS_ORDER_ID_MISMATCH(HttpStatus.CONFLICT, "결제 승인 주문번호가 일치하지 않습니다."),
    TOSS_PAYMENT_KEY_MISMATCH(HttpStatus.CONFLICT, "결제 승인 키가 일치하지 않습니다."),
    TOSS_PAYMENT_NOT_DONE(HttpStatus.CONFLICT, "결제 승인이 완료되지 않았습니다."),
    ...
    PAYMENT_ORDER_MISMATCH(HttpStatus.CONFLICT, "결제 정보와 주문 정보가 일치하지 않습니다."),
    ...
    TOSS_PAYMENT_CONFIRM_FAILED(HttpStatus.BAD_GATEWAY, "토스 결제 승인에 실패했습니다."),
    TOSS_PAYMENT_CONFIRM_UNCERTAIN(HttpStatus.SERVICE_UNAVAILABLE,
            "결제 승인 결과를 확인할 수 없습니다. 잠시 후 다시 확인해 주세요."),
    TOSS_PAYMENT_INVALID_RESPONSE(HttpStatus.BAD_GATEWAY, "토스 결제 승인 응답이 올바르지 않습니다."),
    TOSS_PAYMENT_CANCEL_FAILED(HttpStatus.BAD_GATEWAY, "토스 결제 취소 처리 중 오류가 발생했습니다."),
    TOSS_PAYMENT_NOT_CANCELLED(HttpStatus.CONFLICT, "토스 결제 취소가 완료되지 않았습니다.");
